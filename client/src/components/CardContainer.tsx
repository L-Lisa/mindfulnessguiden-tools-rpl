...
export function CardContainer({ exercises }: CardContainerProps) {
    ...
    <div className="relative w-full h-screen overflow-hidden bg-background" style={{ paddingBottom: 'env(safe-area-inset-bottom)', paddingTop: 'env(safe-area-inset-top)' }}>
      ...
      >
        <div className="max-w-2xl mx-auto h-full flex items-center justify-center px-4">
          <div className="w-full bg-card rounded-2xl shadow-lg overflow-hidden" style={{ boxShadow: '0 4px 12px rgba(41, 53, 86, 0.08)' }}>
            {renderCard()}
          </div>
        </div>
      </div>
